            ...
            <div className="justify-center w-full sm:w-11/12 md:w-10/12 mx-auto">
                    ...
                    <div className="card-body items-center text-center">
                        <div className="w-full mb-12">
                            <div className="flex w-full">
                                <h1 className="text-start font-black text-xl">
                                    Software Developer,{" "}
                                </h1>
                                <h1 className="text-start text-xl ml-2 underline underline-offset-4">
                                    <a
                                ...
                                <h1 className="text-right text-xl grow">
                                    06/2024 – present
                                </h1>
                            </div>
                            ...
                            <div>
                                <ul className="list-disc list-outside pl-4 text-left ">
                                    <li>
                                        ...
                                        managers, designers, and developers to
                                        develop a real-world product.
                                    </li>
                                    <li>
                                        Engage in hands-on, project-based
                                        learning to enhance technical and
                                        teamwork abilities.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        gained valuable insights into product
                                        development.
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="w-full mb-12">
                            ...
                            <div>
                                <ul className="list-disc list-outside pl-4 text-left">
                                    ...
                                    <li>
                                        Leveraged Python and Flask to create
                                        RESTful APIs for seamless
                                    </li>
                                    <li>
                                        Employed React and TypeScript to develop
                                        dynamic user interfaces, enhancing
                                        interactivity and user engagement.
                                    </li>
                                    <li>
                                        Applied object-oriented principles in
                                        Python and JavaScript to design scalable
                                        and maintainable code structures,
                                        enhancing code readability and
                                        modularity.
                                    </li>
                                    <li>
                                        Demonstrated adaptability by quickly
                                        learning new technologies and
                                        frameworks, facilitating the adoption of
                        ...
                        <div className="w-full mb-12">
                            <div className="flex w-full">
                                ...
                                <h1 className="text-start text-xl ml-2 underline underline-offset-4">
                                    <a
                                        href="https://www.luckypawstn.com/"
                                        target="_blank"
                                    >
                                        Lucky Paws Tennessee
                                    </a>
                                </h1>
                                <h1 className="text-right text-xl grow">
                                    02/2023 – present
                            ...
                            <div>
                                <ul className="list-disc list-outside pl-4 text-left">
                                    <li>
                                        ...
                                        skills by managing daily operations and
                                        overseeing the "board & train" program,
                                        coordinating with the training team.
                                    </li>
                                    <li>
                                        Implemented marketing strategies to
                                        attract new clients, demonstrating
                                        creativity and an understanding of
                                        customer needs.
                                    </li>
                                    <li>
                                        Ensured the comfort and well-being of
                                        all canine guests, showing attention to
                                        detail and a commitment to quality.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="w-full mb-12">
                            <div className="flex w-full">
                                ...
                                <h1 className="text-start text-xl ml-2">
                                    Ranger's Squadron
                                </h1>
                                <h1 className="text-right text-xl grow">
                                    10/2012 – 02/2023
                            ...
                            <div>
                                <ul className="list-disc list-outside pl-4 text-left">
                                    <li>
                                        Honed organizational skills through
                                        managing scheduling, bookings, and
                                        client communications in a fast-paced
                                        dog walking and boarding business.
                                    </li>
                                    <li>
                                        Developed strong customer service and
                                        interpersonal skills through client
                                        interactions, resolving issues, and
                                        maintaining positive relationships.
                                    </li>
                                    <li>
                                        Demonstrated problem-solving and
                                        critical thinking by resolving
                                        logistical challenges and addressing
                                        client concerns promptly and
                                        effectively.
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="w-full mb-12">
                            ...
                            <div>
                                <ul className="list-disc list-outside pl-4 text-left">
                                    <li>
                                        Spearheaded integration of online video
                                        content for employment and retail
                                        advertisement in collaboration with
                                        newspaper groups and directory services.
                                    </li>
                                    <li>
                                        Facilitated seamless cooperation among
                                        cross-functional teams including account
                                        managers, scriptwriters, and voice over
                                        talent to ensure the delivery of
                                        customized video content meeting
                                        customer requirements.
                                    </li>
                                    <li>
                                        Employed technical expertise to optimize
                                        video content delivery mechanisms,
                ...
                <div className="card bg-neutral">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 place-content-center text-center">
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            <svg
                                // width="150"
                                // height="150"
                            ...
                            <h1 className="font-bold mt-auto">HTML5</h1>
                        </div>
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            <svg
                                fill="none"
                            ...
                            <h1 className="font-bold mt-auto">CSS3</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">PYTHON</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">JAVASCRIPT</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">TYPESCRIPT</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">C LANGUAGE</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">BOOTSTRAP</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">TAILWIND CSS</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">DJANGO</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">FLASK</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">REACT</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">NODE.JS</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">POSTGRESQL</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">GIT</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">CREATIVE SUITE</h1>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl bg-base-100 m-8 p-4 glass">
                            ...
                            <h1 className="font-bold mt-auto">FINAL CUT PRO</h1>
                        </div>
